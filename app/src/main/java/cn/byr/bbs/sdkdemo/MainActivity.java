...
public class MainActivity extends ActionBarActivity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks,TopTenFragment.TopTenCallbacks {
   ...
   // private WordSubscribeFragment wordSubscribeFragment;
   // private PageSubscribeFragment pageSubscribeFragment;
   // private UserSubscribeFragment userSubscribeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* topTenFragment=TopTenFragment.newInstance();
        topTenFragment.setArguments(getIntent().getExtras());

        wordSubscribeFragment=new WordSubscribeFragment();
        wordSubscribeFragment.setArguments(getIntent().getExtras());

        pageSubscribeFragment=new PageSubscribeFragment();
        pageSubscribeFragment.setArguments(getIntent().getExtras());

        userSubscribeFragment=new UserSubscribeFragment();
        userSubscribeFragment.setArguments(getIntent().getExtras());
*/
    ...
    @Override
    public void onTopTenItemSelected(int position) {
